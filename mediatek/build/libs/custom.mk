...
endef
# Vanzo:songlixin on: Fri, 15 Aug 2014 15:45:52 +0800
# Add more macroes for different team
ifdef 0
...
$(foreach t,$(AUTO_ADD_GLOBAL_DEFINE_BY_VALUE),$(call .if-cfg-on,$(t),$(foreach v, $(call uc,$($(t))),-D$(v))))
$(foreach t,$(AUTO_ADD_GLOBAL_DEFINE_BY_NAME_VALUE),$(call .if-cfg-on,$(t),-D$(call uc,$(t))=\"$($(t))\"))
$(foreach t,$(AUTO_ADD_GLOBAL_DEFINE_BY_NAME_BSP),$(call .if-cfg-on,$(t),-D$(call uc,$(t))))
$(foreach t,$(AUTO_ADD_GLOBAL_DEFINE_BY_VALUE_BSP),$(call .if-cfg-on,$(t),$(foreach v, $(call uc,$($(t))),-D$(v))))
$(foreach t,$(AUTO_ADD_GLOBAL_DEFINE_BY_NAME_VALUE_BSP),$(call .if-cfg-on,$(t),-D$(call uc,$(t))=\"$($(t))\"))
$(foreach t,$(AUTO_ADD_GLOBAL_DEFINE_BY_NAME_APP),$(call .if-cfg-on,$(t),-D$(call uc,$(t))))
$(foreach t,$(AUTO_ADD_GLOBAL_DEFINE_BY_VALUE_APP),$(call .if-cfg-on,$(t),$(foreach v, $(call uc,$($(t))),-D$(v))))
$(foreach t,$(AUTO_ADD_GLOBAL_DEFINE_BY_NAME_VALUE_APP),$(call .if-cfg-on,$(t),-D$(call uc,$(t))=\"$($(t))\"))
$(foreach t,$(AUTO_ADD_GLOBAL_DEFINE_BY_NAME_UI),$(call .if-cfg-on,$(t),-D$(call uc,$(t))))
$(foreach t,$(AUTO_ADD_GLOBAL_DEFINE_BY_VALUE_UI),$(call .if-cfg-on,$(t),$(foreach v, $(call uc,$($(t))),-D$(v))))
$(foreach t,$(AUTO_ADD_GLOBAL_DEFINE_BY_NAME_VALUE_UI),$(call .if-cfg-on,$(t),-D$(call uc,$(t))=\"$($(t))\")))
endef
