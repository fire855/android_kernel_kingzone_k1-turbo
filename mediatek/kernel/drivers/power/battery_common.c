...
/* Vanzo:zhangxinyu on: Wed, 23 Apr 2014 18:52:38 +0800
 */
#if defined(BQ27520)
#include <bq27520.h>
#endif
...
static void mt_battery_Sync_UI_Percentage_to_Real(void)
{
	...
	{
		timer_counter = 0;
/* Vanzo:yangzhihong on: Thu, 11 Sep 2014 15:55:20 +0800
 ...
 */
        ...
        {
#endif
            printk("%s line %d SOC %d bat_full %d\n",__func__,__LINE__,BMT_status.SOC,BMT_status.bat_full);
            if(bat_is_charger_exist() == KAL_TRUE){
                if(BMT_status.SOC <= 99)
                {
                    BMT_status.UI_SOC = BMT_status.SOC;
                }
                else if(BMT_status.SOC == 100)
                {
            ...
            {
                if(BMT_status.UI_SOC == 99 &&  BMT_status.SOC == 100)
                    BMT_status.UI_SOC = 99;
                else
                    BMT_status.UI_SOC = BMT_status.SOC;
            }
...
/* Vanzo:zhangxinyu on: Wed, 23 Apr 2014 18:57:35 +0800
	if(BMT_status.UI_SOC <= 0 )
	{
		BMT_status.UI_SOC=1;
...
/* Vanzo:zhangxinyu on: Wed, 23 Apr 2014 18:59:20 +0800
...
/* Vanzo:yangzhihong on: Thu, 29 May 2014 18:10:50 +0800
...
/* Vanzo:yangzhihong on: Thu, 29 May 2014 18:09:46 +0800
...
{ 
	...
	{
/* Vanzo:zhangxinyu on: Wed, 23 Apr 2014 19:00:59 +0800
...
// End of Vanzo: zhangxinyu
	...
	{
		if (previous_SOC == -1)
/* Vanzo:zhangxinyu on: Wed, 23 Apr 2014 19:03:10 +0800
			SOC = battery_meter_get_battery_percentage();
 */
		{
#if defined(BQ27520)
...
/* Vanzo:zhangxinyu on: Thu, 10 Apr 2014 18:53:43 +0800
 * for some project, we can not read battery temerature
 ...
 */
	...
	if(Bq27520_Exist)
	{
		...
		mtk_current = mt_battery_average_method(&batteryCurrentBuffer[0],ICharging, &icharging_sum, batteryIndex);
...
/* Vanzo:yangzhihong on: Tue, 25 Mar 2014 16:13:12 +0800
#72649
	if(BMT_status.charger_vol > V_CHARGER_MAX)
 */
	if((BMT_status.charger_vol > V_CHARGER_MAX) && (BMT_status.charger_exist == KAL_TRUE))
// End of Vanzo:yangzhihong
    {
...
/* Vanzo:zhangxinyu on: Wed, 23 Apr 2014 19:08:35 +0800
		if (BMT_status.UI_SOC == 100 && BMT_status.charger_exist == KAL_TRUE)
		{
...
void check_battery_exist(void)
{
    ...
    if( baton_count >= 3)
    {
		 ...
		 * system reset when usb plugin (for s5)
        if( (g_platform_boot_mode==META_BOOT) || (g_platform_boot_mode==ADVMETA_BOOT) || (g_platform_boot_mode==ATE_FACTORY_BOOT) )
        {
...
static int battery_resume(struct device *device)
{
	...
	{
/* Vanzo:zhangxinyu on: Wed, 23 Apr 2014 19:11:35 +0800
