...
/* Vanzo:songlixin on: Mon, 24 Mar 2014 21:53:49 +0800
...
{
/* Vanzo:yangzhihong on: Sat, 28 Sep 2013 15:42:28 +0800
 * Can't enter sleep mode when phone startup  first time
	i2c_smbus_write_byte_data(client, MR_REG_M, QMC5983_CC_MODE);
 */
    unsigned char databuf[2] ={MR_REG_M,QMC5983_CC_MODE};
    I2C_TxData(databuf, 2); 
 ...
 * Can't enter sleep mode when phone startup  first time
	i2c_smbus_write_byte_data(client, MR_REG_M, QMC5983_IDLE_MODE);
 */
    unsigned char databuf[2] ={MR_REG_M,QMC5983_IDLE_MODE};
    I2C_TxData(databuf, 2); 
// end of Vanzo:yangzhihong
}
...
/* Vanzo:songlixin on: Mon, 24 Mar 2014 21:42:39 +0800
...
/* Vanzo:songlixin on: Mon, 24 Mar 2014 21:43:51 +0800
