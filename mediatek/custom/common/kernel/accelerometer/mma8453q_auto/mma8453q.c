...
/* Vanzo:songlixin on: Wed, 19 Mar 2014 16:33:05 +0800
...
/* Vanzo:songlixin on: Wed, 19 Mar 2014 16:33:27 +0800
...
/* Vanzo:songlixin on: Wed, 19 Mar 2014 16:44:49 +0800
...
/* Vanzo:songlixin on: Wed, 19 Mar 2014 16:45:01 +0800
...
/* Vanzo:songlixin on: Wed, 19 Mar 2014 16:36:27 +0800
...
/*----------------------------------------------------------------------------*/
/* Vanzo:songlixin on: Wed, 19 Mar 2014 16:37:30 +0800
...
/* Vanzo:songlixin on: Wed, 19 Mar 2014 16:30:26 +0800
...
/*----------------------------------------------------------------------------*/
/* Vanzo:songlixin on: Wed, 19 Mar 2014 16:38:34 +0800
static int mma8453q_i2c_detect(struct i2c_client *client, int kind, struct i2c_board_info *info) 
{    
...
/* Vanzo:maxiaojun on: Thu, 13 Jun 2013 11:28:05 +0800
 */
#if (defined(DCT_V936) || defined(DCT_V7) || defined(DCT_E7) || defined(DCT_V10))
    mt_set_gpio_mode(36, GPIO_MODE_GPIO);
    mt_set_gpio_dir(36, GPIO_DIR_OUT);
...
#if (defined(MT6592))
    mt_set_gpio_mode(11, GPIO_MODE_GPIO);
    mt_set_gpio_dir(11, GPIO_DIR_OUT);
    mt_set_gpio_out(11, 1);
#endif
...
static int  mma8453q_local_init(void)
{
	...
	MMA8453Q_power(hw, 1);
/* Vanzo:songlixin on: Wed, 19 Mar 2014 16:40:24 +0800
...
{
	GSE_FUN();
/* Vanzo:songlixin on: Wed, 19 Mar 2014 16:40:47 +0800
 */
	struct acc_hw *hw = mma8453q_get_cust_acc_hw();
