	...
	{	
		...
		if(GC0310MIPI_MPEG4_encode_mode == KAL_TRUE)
			...
			GC0310MIPI_write_cmos_sensor(0x3c, 0x30);
             		GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
			//GC0310MIPIGammaSelect(GC0310MIPI_RGB_Gamma_night);		
	...
	else 
	{
		...
		if(GC0310MIPI_MPEG4_encode_mode == KAL_TRUE)
			...
			GC0310MIPI_write_cmos_sensor(0x3c, 0x20);
           	       GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
			//GC0310MIPIGammaSelect(GC0310MIPI_RGB_Gamma_m1);				   
...
{
	//Galaxy_Write_Cmos_Sensor = GC0310MIPI_write_cmos_sensor;

	//if(galaxy_check_reg_list_file(Enum_Cmos_Output_Mode_Mipi_1Lane_Full_Size))
	//	return;
  /////////////////////////////////////////////////
	/////////////////	system reg	/////////////////
	/////////////////////////////////////////////////
	...
	GC0310MIPI_write_cmos_sensor(0xf7,0x1f);
	GC0310MIPI_write_cmos_sensor(0xf8,0x03);
	GC0310MIPI_write_cmos_sensor(0xf9,0x0e);
	...
	GC0310MIPI_write_cmos_sensor(0x04,0xe8);
	...
	GC0310MIPI_write_cmos_sensor(0x17,0x17); /* 0x14 mirror flip */
	...
	GC0310MIPI_write_cmos_sensor(0x5a,0x98);
	GC0310MIPI_write_cmos_sensor(0x5b,0xdc);
	GC0310MIPI_write_cmos_sensor(0x5c,0xfe);
	...
	///////////////////   DNDD  /////////////////////
	///////////////////////////////////////////////// 
	GC0310MIPI_write_cmos_sensor(0x82,0x08); 
	...
	GC0310MIPI_write_cmos_sensor(0x92,0x10); 
	GC0310MIPI_write_cmos_sensor(0x93,0x10); 
	GC0310MIPI_write_cmos_sensor(0x95,0x46); 
	GC0310MIPI_write_cmos_sensor(0x96,0x46); 
	...
	GC0310MIPI_write_cmos_sensor(0xbf,0x12);
	GC0310MIPI_write_cmos_sensor(0xc0,0x1d);
	GC0310MIPI_write_cmos_sensor(0xc1,0x35);
	GC0310MIPI_write_cmos_sensor(0xc2,0x4e);
	GC0310MIPI_write_cmos_sensor(0xc3,0x63);
	GC0310MIPI_write_cmos_sensor(0xc4,0x76);
	GC0310MIPI_write_cmos_sensor(0xc5,0x87);
	...
	GC0310MIPI_write_cmos_sensor(0xcc,0xf0);
	GC0310MIPI_write_cmos_sensor(0xcd,0xf8);
	GC0310MIPI_write_cmos_sensor(0xce,0xfc);
	GC0310MIPI_write_cmos_sensor(0xcf,0xff);
	...
	GC0310MIPI_write_cmos_sensor(0xd1,0x30); 
	GC0310MIPI_write_cmos_sensor(0xd2,0x30); 
	...
	GC0310MIPI_write_cmos_sensor(0xdd,0x73); 
	...
	GC0310MIPI_write_cmos_sensor(0x1f,0x30); 
	GC0310MIPI_write_cmos_sensor(0x20,0x40); //80

	
	GC0310MIPI_write_cmos_sensor(0x3e,0x40); 
	GC0310MIPI_write_cmos_sensor(0x3f,0x5c); 
	GC0310MIPI_write_cmos_sensor(0x40,0x7b); 
	GC0310MIPI_write_cmos_sensor(0x41,0xbd); 
	GC0310MIPI_write_cmos_sensor(0x42,0xf6); 
	GC0310MIPI_write_cmos_sensor(0x43,0x63); 
	//GC0310MIPI_write_cmos_sensor(0x04,0xe3);
	GC0310MIPI_write_cmos_sensor(0x03,0x60);
	
	GC0310MIPI_write_cmos_sensor(0x44,0x03);
	...
	GC0310MIPI_write_cmos_sensor(0x6c,0x10); 
	GC0310MIPI_write_cmos_sensor(0x6d,0x00); 
	GC0310MIPI_write_cmos_sensor(0x6e,0xf0); 
	GC0310MIPI_write_cmos_sensor(0x6f,0xd0); 
	//GC0310MIPI_write_cmos_sensor(0x70,0x00);
 
	 
	GC0310MIPI_write_cmos_sensor(0x78,0xaf); 
	GC0310MIPI_write_cmos_sensor(0x79,0x75);
	GC0310MIPI_write_cmos_sensor(0x7a,0x40);
	GC0310MIPI_write_cmos_sensor(0x7b,0x66);	
	...
	////////////////////   CC    ////////////////////
	/////////////////////////////////////////////////
	GC0310MIPI_write_cmos_sensor(0xd0,0x45);
	GC0310MIPI_write_cmos_sensor(0xd1,0x06);
	GC0310MIPI_write_cmos_sensor(0xd2,0x0f);
	GC0310MIPI_write_cmos_sensor(0xd3,0xff);
	GC0310MIPI_write_cmos_sensor(0xd4,0x40);
	GC0310MIPI_write_cmos_sensor(0xd5,0x03);
	GC0310MIPI_write_cmos_sensor(0xd6,0x3f);
	GC0310MIPI_write_cmos_sensor(0xd7,0xf8);
	GC0310MIPI_write_cmos_sensor(0xd8,0x05);
	GC0310MIPI_write_cmos_sensor(0xd9,0x08);
	GC0310MIPI_write_cmos_sensor(0xda,0x38);
	...
	GC0310MIPI_write_cmos_sensor(0x06, 0x0a); 
	GC0310MIPI_write_cmos_sensor(0x07, 0x00);
	GC0310MIPI_write_cmos_sensor(0x08, 0x89);
	...
	GC0310MIPI_write_cmos_sensor(0x27, 0x02);   //exp level 0  14.28fps
	GC0310MIPI_write_cmos_sensor(0x28, 0x71); 
	GC0310MIPI_write_cmos_sensor(0x29, 0x03);   //exp level 1  12.50fps
	GC0310MIPI_write_cmos_sensor(0x2a, 0xe8); 
	GC0310MIPI_write_cmos_sensor(0x2b, 0x05);   //exp level 2  10.00fps
	GC0310MIPI_write_cmos_sensor(0x2c, 0xdc); 
	GC0310MIPI_write_cmos_sensor(0x2d, 0x07);   //exp level 3  7.14fps
	...
	GC0310MIPI_write_cmos_sensor(0x01, 0x03); ///mipi 1lane
	GC0310MIPI_write_cmos_sensor(0x02, 0x22);
	GC0310MIPI_write_cmos_sensor(0x03, 0x94);
	GC0310MIPI_write_cmos_sensor(0x04, 0x01); // fifo_prog 
	GC0310MIPI_write_cmos_sensor(0x05, 0x00); //fifo_prog 
	GC0310MIPI_write_cmos_sensor(0x06, 0x80); //b0  //YUV ISP data	
	GC0310MIPI_write_cmos_sensor(0x10, 0x90); //94 // last bit  lane num 
	GC0310MIPI_write_cmos_sensor(0x11, 0x1e); //LDI set YUV422
	GC0310MIPI_write_cmos_sensor(0x12, 0x00); //04 //00 //04//00 //LWC[7:0]	//
	GC0310MIPI_write_cmos_sensor(0x13, 0x05); //05 //LWC[15:8]
	GC0310MIPI_write_cmos_sensor(0x15, 0x12); //DPHYY_MODE read_ready 
	GC0310MIPI_write_cmos_sensor(0x17, 0xf0); 

	GC0310MIPI_write_cmos_sensor(0x21, 0x02);
	GC0310MIPI_write_cmos_sensor(0x22, 0x02);
	GC0310MIPI_write_cmos_sensor(0x23, 0x01);
	GC0310MIPI_write_cmos_sensor(0x29, 0x02);
	GC0310MIPI_write_cmos_sensor(0x2a, 0x04);
	GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
...
{
    int  retry = 3; 
	static bool isFristReadID = FALSE;
    ...
    do {
        *sensorID=((GC0310MIPI_read_cmos_sensor(0xf0)<< 8)|GC0310MIPI_read_cmos_sensor(0xf1));
        if (*sensorID == GC0310MIPI_SENSOR_ID)
            break; 
        SENSORDB("GC0310MIPIGetSensorID Fail id = 0x%04x\n", *sensorID);
        retry--; 
    } while (retry > 0);
	...
	SENSORDB("GC0310MIPIGetSensorID id = 0x%04x\n", *sensorID);
	isFristReadID = TRUE;
...
BOOL GC0310MIPI_set_param_banding(UINT16 para)
{
	switch (para)
	{
		...
		case AE_FLICKER_MODE_60HZ:
			...
			GC0310MIPI_write_cmos_sensor(0x07, 0x00);
			GC0310MIPI_write_cmos_sensor(0x08, 0xe8);
			
			GC0310MIPI_SET_PAGE1;
			GC0310MIPI_write_cmos_sensor(0x25, 0x00);   //anti-flicker step [11:8]
			GC0310MIPI_write_cmos_sensor(0x26, 0x64);   //anti-flicker step [7:0]
			
			GC0310MIPI_write_cmos_sensor(0x27, 0x02);   //exp level 0  15.00fps
			GC0310MIPI_write_cmos_sensor(0x28, 0xbc); 
			GC0310MIPI_write_cmos_sensor(0x29, 0x03);   //exp level 0  12.00fps
			GC0310MIPI_write_cmos_sensor(0x2a, 0xe8); 
			GC0310MIPI_write_cmos_sensor(0x2b, 0x04);   //exp level 0  10.00fps
			GC0310MIPI_write_cmos_sensor(0x2c, 0xb0); 
			GC0310MIPI_write_cmos_sensor(0x2d, 0x06);   //exp level 0  7.05fps
...
BOOL GC0310MIPI_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:		
			GC0310MIPI_write_cmos_sensor(0xfe, 0x01);
			GC0310MIPI_write_cmos_sensor(0x13, 0x30);//35
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
		break;
