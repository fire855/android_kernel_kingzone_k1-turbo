...
static void GC2145MIPI_Sensor_Init(void)
{
	...
	if(0 == strncmp(VANZO_SUB_CAM_ROTATION, "0", 1)) {
		GC2145MIPI_write_cmos_sensor(0x17, 0x17);
	} else {
		GC2145MIPI_write_cmos_sensor(0x17, 0x14);
	}
	...
	////////////////////  ISP reg  //////////////////////
	//////////////////////////////////////////////////////
	GC2145MIPI_write_cmos_sensor(0x80, 0xff);
	GC2145MIPI_write_cmos_sensor(0x81, 0x24);
	...
	GC2145MIPI_write_cmos_sensor(0x85, 0x30);
	...
	GC2145MIPI_write_cmos_sensor(0x43, 0x54);
	...
	GC2145MIPI_write_cmos_sensor(0x6a, 0x02);
	GC2145MIPI_write_cmos_sensor(0x6b, 0x02);
	GC2145MIPI_write_cmos_sensor(0x6c, 0x02);
	GC2145MIPI_write_cmos_sensor(0x6d, 0x02);
	GC2145MIPI_write_cmos_sensor(0x6e, 0x02);
	GC2145MIPI_write_cmos_sensor(0x6f, 0x02);
	GC2145MIPI_write_cmos_sensor(0x70, 0x02);
	GC2145MIPI_write_cmos_sensor(0x71, 0x02);
	GC2145MIPI_write_cmos_sensor(0x76, 0x00);
	...
	GC2145MIPI_write_cmos_sensor(0x07, 0x20);
	GC2145MIPI_write_cmos_sensor(0x08, 0x70);
	GC2145MIPI_write_cmos_sensor(0x09, 0x00);
	...
	GC2145MIPI_write_cmos_sensor(0xfe, 0x01);
	GC2145MIPI_write_cmos_sensor(0x12, 0x00);
	...
	GC2145MIPI_write_cmos_sensor(0x92, 0xc8);
	GC2145MIPI_write_cmos_sensor(0x94, 0x66);
	GC2145MIPI_write_cmos_sensor(0x95, 0xb5);
	GC2145MIPI_write_cmos_sensor(0x97, 0x64);
	...
	GC2145MIPI_write_cmos_sensor(0x82, 0x08);
	GC2145MIPI_write_cmos_sensor(0x83, 0x05);
	...
	GC2145MIPI_write_cmos_sensor(0xfe, 0x02);
	GC2145MIPI_write_cmos_sensor(0xa3, 0x40);
	...
	GC2145MIPI_write_cmos_sensor(0xb3, 0x34);
	GC2145MIPI_write_cmos_sensor(0xb4, 0x44);
	GC2145MIPI_write_cmos_sensor(0xb6, 0x38);
	GC2145MIPI_write_cmos_sensor(0xb7, 0x02);
	GC2145MIPI_write_cmos_sensor(0xb9, 0x30);
	GC2145MIPI_write_cmos_sensor(0x3c, 0x08);
	GC2145MIPI_write_cmos_sensor(0x3d, 0x30);
	GC2145MIPI_write_cmos_sensor(0x4b, 0x0d);
	...
	*/
	...
	///////////////////////////////////////////////  
	GC2145MIPI_write_cmos_sensor(0xfe, 0x02);
	GC2145MIPI_write_cmos_sensor(0xd1, 0x30);
	GC2145MIPI_write_cmos_sensor(0xd2, 0x30);
	GC2145MIPI_write_cmos_sensor(0xd3, 0x45);
	GC2145MIPI_write_cmos_sensor(0xdd, 0x14);
	GC2145MIPI_write_cmos_sensor(0xde, 0x86);
	GC2145MIPI_write_cmos_sensor(0xed, 0x01);
	GC2145MIPI_write_cmos_sensor(0xee, 0x28);
	GC2145MIPI_write_cmos_sensor(0xef, 0x30);
	...
	////////////////////////////
	GC2145MIPI_write_cmos_sensor(0xfe, 0x01);
	GC2145MIPI_write_cmos_sensor(0xc2, 0x1a);
	GC2145MIPI_write_cmos_sensor(0xc3, 0x0b);
	GC2145MIPI_write_cmos_sensor(0xc4, 0x0e);
	GC2145MIPI_write_cmos_sensor(0xc8, 0x20);
	GC2145MIPI_write_cmos_sensor(0xc9, 0x0c);
	GC2145MIPI_write_cmos_sensor(0xca, 0x12);
	GC2145MIPI_write_cmos_sensor(0xbc, 0x41);
	GC2145MIPI_write_cmos_sensor(0xbd, 0x1f);
	GC2145MIPI_write_cmos_sensor(0xbe, 0x29);
	GC2145MIPI_write_cmos_sensor(0xb6, 0x48);
	GC2145MIPI_write_cmos_sensor(0xb7, 0x22);
	GC2145MIPI_write_cmos_sensor(0xb8, 0x28);
	GC2145MIPI_write_cmos_sensor(0xc5, 0x04);
	GC2145MIPI_write_cmos_sensor(0xc6, 0x00);
	GC2145MIPI_write_cmos_sensor(0xc7, 0x00);
	GC2145MIPI_write_cmos_sensor(0xcb, 0x12);
	GC2145MIPI_write_cmos_sensor(0xcc, 0x00);
	GC2145MIPI_write_cmos_sensor(0xcd, 0x08);
	GC2145MIPI_write_cmos_sensor(0xbf, 0x14);
	GC2145MIPI_write_cmos_sensor(0xc0, 0x00);
	GC2145MIPI_write_cmos_sensor(0xc1, 0x10);
	GC2145MIPI_write_cmos_sensor(0xb9, 0x0f);
	GC2145MIPI_write_cmos_sensor(0xba, 0x00);
	GC2145MIPI_write_cmos_sensor(0xbb, 0x00);
	GC2145MIPI_write_cmos_sensor(0xaa, 0x0a);
	GC2145MIPI_write_cmos_sensor(0xab, 0x00);
	GC2145MIPI_write_cmos_sensor(0xac, 0x00);
	GC2145MIPI_write_cmos_sensor(0xad, 0x09);
	GC2145MIPI_write_cmos_sensor(0xae, 0x00);
	GC2145MIPI_write_cmos_sensor(0xaf, 0x02);
	GC2145MIPI_write_cmos_sensor(0xb0, 0x04);
	GC2145MIPI_write_cmos_sensor(0xb1, 0x00);
	GC2145MIPI_write_cmos_sensor(0xb2, 0x00);
	GC2145MIPI_write_cmos_sensor(0xb3, 0x03);
	GC2145MIPI_write_cmos_sensor(0xb4, 0x00);
	GC2145MIPI_write_cmos_sensor(0xb5, 0x02);
	GC2145MIPI_write_cmos_sensor(0xd0, 0x42);
	GC2145MIPI_write_cmos_sensor(0xd1, 0x00);
	GC2145MIPI_write_cmos_sensor(0xd2, 0x00);
	GC2145MIPI_write_cmos_sensor(0xd6, 0x47);
	GC2145MIPI_write_cmos_sensor(0xd7, 0x07);
	GC2145MIPI_write_cmos_sensor(0xd8, 0x00);
	GC2145MIPI_write_cmos_sensor(0xd9, 0x34);
	GC2145MIPI_write_cmos_sensor(0xda, 0x13);
	GC2145MIPI_write_cmos_sensor(0xdb, 0x00);
	GC2145MIPI_write_cmos_sensor(0xd3, 0x2b);
	GC2145MIPI_write_cmos_sensor(0xd4, 0x18);
	GC2145MIPI_write_cmos_sensor(0xd5, 0x10);
	...
	GC2145MIPI_write_cmos_sensor(0xfe, 0x01);
	GC2145MIPI_write_cmos_sensor(0xdf, 0x00);
	GC2145MIPI_write_cmos_sensor(0xdc, 0x80);
	GC2145MIPI_write_cmos_sensor(0xdd, 0x30);
	GC2145MIPI_write_cmos_sensor(0xe0, 0x6b);
	GC2145MIPI_write_cmos_sensor(0xe1, 0x70);
	GC2145MIPI_write_cmos_sensor(0xe2, 0x6b);
	GC2145MIPI_write_cmos_sensor(0xe3, 0x70);
	GC2145MIPI_write_cmos_sensor(0xe6, 0xa0);
	GC2145MIPI_write_cmos_sensor(0xe7, 0x60);
	GC2145MIPI_write_cmos_sensor(0xe8, 0xa0);
	GC2145MIPI_write_cmos_sensor(0xe9, 0x60);
	GC2145MIPI_write_cmos_sensor(0xfe, 0x00);
	...
	GC2145MIPI_write_cmos_sensor(0x4e, 0x07);
	GC2145MIPI_write_cmos_sensor(0x4c, 0x02);
	GC2145MIPI_write_cmos_sensor(0x4d, 0xa8);
	GC2145MIPI_write_cmos_sensor(0x4e, 0x07);
	GC2145MIPI_write_cmos_sensor(0x4c, 0x02);
	GC2145MIPI_write_cmos_sensor(0x4d, 0x88);
	GC2145MIPI_write_cmos_sensor(0x4e, 0x07);
	GC2145MIPI_write_cmos_sensor(0x4f, 0x01);
	GC2145MIPI_write_cmos_sensor(0x50, 0x80); 
	GC2145MIPI_write_cmos_sensor(0x51, 0xa8);
	GC2145MIPI_write_cmos_sensor(0x52, 0x57);
	GC2145MIPI_write_cmos_sensor(0x53, 0x38);
	GC2145MIPI_write_cmos_sensor(0x54, 0xc7);
	GC2145MIPI_write_cmos_sensor(0x56, 0x0e);
	GC2145MIPI_write_cmos_sensor(0x58, 0x09);
	GC2145MIPI_write_cmos_sensor(0x5b, 0x00);
	GC2145MIPI_write_cmos_sensor(0x5c, 0x74);
	GC2145MIPI_write_cmos_sensor(0x5d, 0x8b);
	GC2145MIPI_write_cmos_sensor(0x61, 0xa7);
	GC2145MIPI_write_cmos_sensor(0x62, 0xb5);
	GC2145MIPI_write_cmos_sensor(0x63, 0xaa);
	GC2145MIPI_write_cmos_sensor(0x64, 0x80);
	GC2145MIPI_write_cmos_sensor(0x65, 0x04);
	GC2145MIPI_write_cmos_sensor(0x67, 0xa4);
	GC2145MIPI_write_cmos_sensor(0x68, 0xb0);
	GC2145MIPI_write_cmos_sensor(0x69, 0x00);
	GC2145MIPI_write_cmos_sensor(0x6a, 0xa4);
	GC2145MIPI_write_cmos_sensor(0x6b, 0xb0); 
	GC2145MIPI_write_cmos_sensor(0x6c, 0xb2); 
	GC2145MIPI_write_cmos_sensor(0x6d, 0xac); 
	GC2145MIPI_write_cmos_sensor(0x6e, 0x60); 
	GC2145MIPI_write_cmos_sensor(0x6f, 0x15);
	GC2145MIPI_write_cmos_sensor(0x73, 0x0f); 
	GC2145MIPI_write_cmos_sensor(0x70, 0x10); 
	GC2145MIPI_write_cmos_sensor(0x71, 0xe8); 
	GC2145MIPI_write_cmos_sensor(0x72, 0xc0); 
	...
	GC2145MIPI_write_cmos_sensor(0xc2, 0xF4);
	GC2145MIPI_write_cmos_sensor(0xc3, 0x02);
	GC2145MIPI_write_cmos_sensor(0xc4, 0xf2);
	GC2145MIPI_write_cmos_sensor(0xc5, 0x44);
	GC2145MIPI_write_cmos_sensor(0xc6, 0xf8);
	...
	GC2145MIPI_write_cmos_sensor(0xCd, 0x45);
	GC2145MIPI_write_cmos_sensor(0xce, 0xf0);
	GC2145MIPI_write_cmos_sensor(0xcf, 0x00);
	GC2145MIPI_write_cmos_sensor(0xe3, 0xf0);
	GC2145MIPI_write_cmos_sensor(0xe4, 0x45);
	GC2145MIPI_write_cmos_sensor(0xe5, 0xe8);
	GC2145MIPI_write_cmos_sensor(0xfe, 0x00);
	GC2145MIPI_write_cmos_sensor(0xf2, 0x00);
