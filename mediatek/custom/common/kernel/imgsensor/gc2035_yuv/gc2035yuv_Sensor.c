...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0xbc , 0x38);//40
	...
	GC2035_write_cmos_sensor(0xd4 , 0x00);//00
	GC2035_write_cmos_sensor(0xd6 , 0x17);//14
	GC2035_write_cmos_sensor(0xd7 , 0x1b);//17
	...
	GC2035_write_cmos_sensor(0xc1 , 0x34); //Green_cc for d
	...
	////////////YCP//////////
	GC2035_write_cmos_sensor(0xd1 , 0x28);//saturation_cb
	GC2035_write_cmos_sensor(0xd2 , 0x28);//saturation_Cr
	
	GC2035_write_cmos_sensor(0xad , 0x80);//R_ratio
	GC2035_write_cmos_sensor(0xae , 0x82);//G
	GC2035_write_cmos_sensor(0xaf , 0x86);//B
		
	GC2035_write_cmos_sensor(0xd3 , 0x3c);//contrast Ó
