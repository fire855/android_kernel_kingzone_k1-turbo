...
void GC0312_Sensor_Init(void)
{
	...
	///////////////////   DNDD  /////////////////////
	///////////////////////////////////////////////// 
	GC0312_write_cmos_sensor(0x82, 0x15); //14 
	GC0312_write_cmos_sensor(0x83, 0x15); // 0b jibing
	GC0312_write_cmos_sensor(0x89, 0xf0);
	
	///////////////////////////////////////////////// 
	//////////////////   EEINTP  ////////////////////
	///////////////////////////////////////////////// 
	GC0312_write_cmos_sensor(0x8f, 0x88); //aa
	GC0312_write_cmos_sensor(0x90, 0x9c); 
...
*/
	...
	GC0312_write_cmos_sensor(0x2b, 0x03);   //7.14fps
	GC0312_write_cmos_sensor(0x2c, 0x50); 
...
BOOL GC0312_set_param_banding(UINT16 para)
{
	switch (para)
	{
		...
		case AE_FLICKER_MODE_60HZ:
			...
			GC0312_write_cmos_sensor(0x2a, 0x00); 
			GC0312_write_cmos_sensor(0x2b, 0x03);   //exp level 2  7.5fps
			GC0312_write_cmos_sensor(0x2c, 0x60); 
