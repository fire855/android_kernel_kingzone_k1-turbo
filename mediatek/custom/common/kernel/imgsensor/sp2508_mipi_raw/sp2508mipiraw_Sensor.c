...
SP2508MIPI_write_cmos_sensor(0x24,0xf0); //pga gain 6x
...
SP2508MIPI_write_cmos_sensor(0xf0,0x00);//offset  0x10
SP2508MIPI_write_cmos_sensor(0xf1,0x00);//0x10
SP2508MIPI_write_cmos_sensor(0xf2,0x00);//0x10
SP2508MIPI_write_cmos_sensor(0xf3,0x00);//0x10
//SP2508MIPI_write_cmos_sensor(0xfd,0x02); //raw data digital gain
//SP2508MIPI_write_cmos_sensor(0x00,0x84);
//SP2508MIPI_write_cmos_sensor(0x01,0x84);
//SP2508MIPI_write_cmos_sensor(0x03,0x84);
//SP2508MIPI_write_cmos_sensor(0x04,0x84); 
                                                                ...
                                                                UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    switch (FeatureId)
    {
        ...
        case SENSOR_FEATURE_GET_ENG_INFO:
            ...
            //pSensorEngInfo->SensorOutputDataFormat=SENSOR_OUTPUT_FORMAT_RAW_B;//hanlei
