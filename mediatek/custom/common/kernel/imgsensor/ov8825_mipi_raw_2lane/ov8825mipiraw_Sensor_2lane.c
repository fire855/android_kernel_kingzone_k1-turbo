...
/* Vanzo:songlixin on: Tue, 22 Apr 2014 21:07:38 +0800
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	spin_unlock(&ov8825mipiraw_drv_lock);
/* Vanzo:songlixin on: Tue, 22 Apr 2014 21:08:50 +0800
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	ov8825.imgMirror = sensor_config_data->SensorImageMirror;
	spin_unlock(&ov8825mipiraw_drv_lock);
/* Vanzo:songlixin on: Tue, 22 Apr 2014 21:09:56 +0800
	//OV8825SetFlipMirror(sensor_config_data->SensorImageMirror);
	OV8825SetFlipMirror(IMAGE_HV_MIRROR);
 */
	if(0 == strncmp(VANZO_MAIN_CAM_ROTATION, "180", 3))
...
/* Vanzo:songlixin on: Tue, 22 Apr 2014 21:10:26 +0800
	//OV8825SetFlipMirror(sensor_config_data->SensorImageMirror);
	OV8825SetFlipMirror(IMAGE_HV_MIRROR);
 */
	if(0 == strncmp(VANZO_MAIN_CAM_ROTATION, "180", 3))
