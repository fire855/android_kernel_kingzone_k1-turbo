...
typedef struct
{
	...
	#define OV8865_FULL_X_START						    		(0)
	#define OV8865_FULL_Y_START						    		(0)
	#define OV8865_PV_X_START						    		(0)
	#define OV8865_PV_Y_START						    		(0)
	#define OV8865_VIDEO_X_START								(0)
	...
	#define OV8865MIPI_WRITE_ID 	(0x6c)	//6c
	#define OV8865MIPI_READ_ID	(0x6d)		//6d
