...
#define S5K3L2XX_TEST_PATTERN_CHECKSUM (0xa244dfc0)
...
#ifdef MULTIPLE_I2C_SUPPORT
static kal_uint8 s5k3l2xx_init[] = {
}
#endif
...
void S5K3L2XXInitSetting(void)
{
    ...
    totalCnt = ARRAY_SIZE(s5k3l2xx_init);
	transfer_len = totalCnt / transac_len;
	len = (transfer_len<<8)|transac_len;    
	S5K3L2XXDB("[S5K3L2XX] [S5K3L2XXInitSetting] Total Count = %d, Len = 0x%x\n", totalCnt,len);    
	memcpy(pBuf, &s5k3l2xx_init, totalCnt );   
	dmaHandle = dma_map_single(NULL, pBuf, 1024, DMA_TO_DEVICE);	
	S5K3L2XX_multi_write_cmos_sensor(dmaHandle, len); 
	...
	S5K3L2XX_write_cmos_sensor1(0x6F12,0x0006);
	S5K3L2XX_write_cmos_sensor1(0x6F12,0x00E8);
	...
	S5K3L2XX_write_cmos_sensor1(0x6F12,0x2398); 		//1198		//1e80																		
	S5K3L2XX_write_cmos_sensor1(0x602A,0x0340);    //frame length lines 													 
	S5K3L2XX_write_cmos_sensor1(0x6F12,0x0708); 		//0C7C	//1872 -->1800																			
	...
	S5K3L2XX_write_cmos_sensor(0x0100,0x01);	//#smiaRegs_rw_general_setup_mode_select 01  
	*/
#endif
	mdelay(30);
}
...
void S5K3L2XXPreviewSetting(void)
{
	...
	S5K3L2XX_write_cmos_sensor(0x6F12,0x01);																				  
	S5K3L2XX_write_cmos_sensor1(0x602A,0x0342);	  //line length 														  
	S5K3L2XX_write_cmos_sensor1(0x6F12,0x1570);			//1198 //1e80																				
	S5K3L2XX_write_cmos_sensor1(0x602A,0x0340);	//frame length lines													  
	S5K3L2XX_write_cmos_sensor1(0x6F12,0x0A3F);			//0C7C	//1872 -->1800 b																			
	S5K3L2XX_write_cmos_sensor1(0x602A,0x034C);	//#smiaRegs_rw_frame_timing_x_output_size	1070						   
	S5K3L2XX_write_cmos_sensor1(0x6F12,0x0838);																			  
	S5K3L2XX_write_cmos_sensor1(0x6F12,0x0618);	//#smiaRegs_rw_frame_timing_y_output_size	0C30						   
	S5K3L2XX_write_cmos_sensor1(0x602A,0x0114);																			  
	...
	S5K3L2XX_write_cmos_sensor1(0x6F12,0x0004);	//#smiaRegs_rw_frame_timing_y_addr_start	0004							 
	S5K3L2XX_write_cmos_sensor1(0x6F12,0x0004);																			  
	S5K3L2XX_write_cmos_sensor1(0x6F12,0x1075);	//#smiaRegs_rw_frame_timing_x_addr_end	1073							   
	S5K3L2XX_write_cmos_sensor1(0x6F12,0x0C33);	//#smiaRegs_rw_frame_timing_y_addr_end									   
	S5K3L2XX_write_cmos_sensor1(0x602A,0x3010);	//#smiaRegs_vendor_sensor_offset_x 0000 								  
	S5K3L2XX_write_cmos_sensor1(0x6F12,0x0001);																			  
	S5K3L2XX_write_cmos_sensor1(0x6F12,0x0000);	//#smiaRegs_vendor_sensor_offset_y 0001 								  
	S5K3L2XX_write_cmos_sensor1(0x602A,0x0386);	//#smiaRegs_rw_sub_sample_y_odd_inc 0001								 
	S5K3L2XX_write_cmos_sensor1(0x6F12,0x0003);																			  
	S5K3L2XX_write_cmos_sensor1(0x602A,0x0382);	//#smiaRegs_rw_sub_sample_x_odd_inc 0001								 
	S5K3L2XX_write_cmos_sensor1(0x6F12,0x0003);																			  
...
void S5K3L2XXCaptureSetting(void)
{
	...
	S5K3L2XX_write_cmos_sensor1(0x6F12,0x1630);   //line length		//1e80			//2398							
	S5K3L2XX_write_cmos_sensor1(0x602A,0x0340);																		 
	S5K3L2XX_write_cmos_sensor1(0x6F12,0x0C60);   //frame length lines 												 
