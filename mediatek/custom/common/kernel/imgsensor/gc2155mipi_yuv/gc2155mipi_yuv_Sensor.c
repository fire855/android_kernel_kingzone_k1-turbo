...
static void GC2155MIPI_Sensor_Init(void)
{
	...
	GC2155MIPI_write_cmos_sensor(0xf8, 0x83);
	GC2155MIPI_write_cmos_sensor(0xfa, 0x00);
	GC2155MIPI_write_cmos_sensor(0xf9, 0x8e); // fe
	...
	GC2155MIPI_write_cmos_sensor(0x17 , 0x14); // 0x17
	...
	GC2155MIPI_write_cmos_sensor(0x6a , 0x0a); //manual offset
	GC2155MIPI_write_cmos_sensor(0x6b , 0x0a);
	GC2155MIPI_write_cmos_sensor(0x6c , 0x0a);
	GC2155MIPI_write_cmos_sensor(0x6d , 0x0a);
	GC2155MIPI_write_cmos_sensor(0x6e , 0x0a);
	GC2155MIPI_write_cmos_sensor(0x6f , 0x0a);
	GC2155MIPI_write_cmos_sensor(0x70 , 0x0a);
	GC2155MIPI_write_cmos_sensor(0x71 , 0x0a);
	...
	GC2155MIPI_write_cmos_sensor(0x13 , 0x2d); //AEC Y target
	...
	GC2155MIPI_write_cmos_sensor(0x15 , 0x55); //target_Y_high_limit
	...
	GC2155MIPI_write_cmos_sensor(0x91 , 0x03); //eeintp mode2
	GC2155MIPI_write_cmos_sensor(0x92 , 0xc4); //low criteria for direction
	GC2155MIPI_write_cmos_sensor(0x97 , 0x67); //54 //edge effect
	...
	GC2155MIPI_write_cmos_sensor(0xa3 , 0x50); //ASDE_low_luma_value_LSC_th_H,0x 
	GC2155MIPI_write_cmos_sensor(0xa4 , 0x30); //ASDE_low_luma_value_LSC_th_L,0x 
	GC2155MIPI_write_cmos_sensor(0xa5 , 0x40);
	GC2155MIPI_write_cmos_sensor(0xa6 , 0x80);
	GC2155MIPI_write_cmos_sensor(0xab , 0x40); //20 //ASDE_low_luma_value_OT_th 
	...
	GC2155MIPI_write_cmos_sensor(0xb9 , 0x28); //ASDE_auto_saturation_low_limit
	GC2155MIPI_write_cmos_sensor(0xfe , 0x00);	 
	///////////////////gamma1////////////////////
	GC2155MIPI_write_cmos_sensor(0xfe , 0x02);
	...
	/////////////////////////////////////////////// 
	GC2155MIPI_write_cmos_sensor(0xfe , 0x02);
	GC2155MIPI_write_cmos_sensor(0xd1,0x30);//24 //saturation_Cb
	GC2155MIPI_write_cmos_sensor(0xd2,0x30);//24 //saturation_Cr 
	GC2155MIPI_write_cmos_sensor(0xd3,0x42);
	...
	////////////////////////////
	GC2155MIPI_write_cmos_sensor(0xfe , 0x01);
	GC2155MIPI_write_cmos_sensor(0xc2,0x16);//23
	GC2155MIPI_write_cmos_sensor(0xc3,0x15);
	GC2155MIPI_write_cmos_sensor(0xc4,0x14);
	GC2155MIPI_write_cmos_sensor(0xc8,0x18);//1a
	GC2155MIPI_write_cmos_sensor(0xc9,0x15);//1b
	GC2155MIPI_write_cmos_sensor(0xca,0x04);
	GC2155MIPI_write_cmos_sensor(0xbc,0x42);//58
	GC2155MIPI_write_cmos_sensor(0xbd,0x34);
	GC2155MIPI_write_cmos_sensor(0xbe,0x31);
	GC2155MIPI_write_cmos_sensor(0xb6,0x4a);//5d
	GC2155MIPI_write_cmos_sensor(0xb7,0x32);
	GC2155MIPI_write_cmos_sensor(0xb8,0x2f);
	...
	GC2155MIPI_write_cmos_sensor(0xb3,0x0c);
	GC2155MIPI_write_cmos_sensor(0xb4,0x08);
	GC2155MIPI_write_cmos_sensor(0xb5,0x07);
	GC2155MIPI_write_cmos_sensor(0xd0,0x0e);
	GC2155MIPI_write_cmos_sensor(0xd1 , 0x00);
	GC2155MIPI_write_cmos_sensor(0xd2 , 0x00);
	GC2155MIPI_write_cmos_sensor(0xd6,0x03);
	...
	GC2155MIPI_write_cmos_sensor(0xd3,0x27);
	...
	GC2155MIPI_write_cmos_sensor(0xe0,0x67);
	GC2155MIPI_write_cmos_sensor(0xe1,0x80);
	GC2155MIPI_write_cmos_sensor(0xe2,0x54);
	GC2155MIPI_write_cmos_sensor(0xe3,0x88);
	GC2155MIPI_write_cmos_sensor(0xe6,0x9a);
	GC2155MIPI_write_cmos_sensor(0xe7,0x80);
	GC2155MIPI_write_cmos_sensor(0xe8,0x9d);
	GC2155MIPI_write_cmos_sensor(0xe9,0x88);
	GC2155MIPI_write_cmos_sensor(0xfe , 0x00);
	///////////////////////////////////////////////
	/////////// AWB////////////////////////
	///////////////////////////////////////////////
	...
	GC2155MIPI_write_cmos_sensor(0x4e , 0x06);
	GC2155MIPI_write_cmos_sensor(0x4c , 0x02);
	GC2155MIPI_write_cmos_sensor(0x4d,0x88);
	...
	GC2155MIPI_write_cmos_sensor(0x63,0xAA); //04
	...
	GC2155MIPI_write_cmos_sensor(0x77,0x48); //G limit
	GC2155MIPI_write_cmos_sensor(0x78,0xa0); //B limit
	GC2155MIPI_write_cmos_sensor(0xfe , 0x00);
	//////////////////////////////////////////
	///////////CC////////////////////////
	//////////////////////////////////////////
	...
	GC2155MIPI_write_cmos_sensor(0xc1,0x40);
	GC2155MIPI_write_cmos_sensor(0xc2,0xf3);
	GC2155MIPI_write_cmos_sensor(0xc3,0x00);
	GC2155MIPI_write_cmos_sensor(0xc4,0xe0);
	GC2155MIPI_write_cmos_sensor(0xc5,0x42);
	GC2155MIPI_write_cmos_sensor(0xc6,0xF8); //D65
	...
	GC2155MIPI_write_cmos_sensor(0x08,0x14);
	GC2155MIPI_write_cmos_sensor(0xfe , 0x01);
	...
	GC2155MIPI_write_cmos_sensor(0x29,0x05); //16.7fps
	GC2155MIPI_write_cmos_sensor(0x2a,0xdc);
	GC2155MIPI_write_cmos_sensor(0x2b , 0x09); //09
	GC2155MIPI_write_cmos_sensor(0x2c,0xC4);
...
BOOL GC2155MIPI_set_param_banding(UINT16 para)
{
    switch (para)
    {
		...
		GC2155MIPI_write_cmos_sensor(0x2a , 0xd0); //16fps 
		GC2155MIPI_write_cmos_sensor(0x2b , 0x09); 
		GC2155MIPI_write_cmos_sensor(0x2c , 0xc4); //14fps 
		GC2155MIPI_write_cmos_sensor(0x2d , 0x0b); 
		GC2155MIPI_write_cmos_sensor(0x2e , 0xb8); //8fps
		GC2155MIPI_write_cmos_sensor(0xfe , 0x00);
            break;
...
static void GC2155_FlashTriggerCheck(unsigned int *pFeatureReturnPara32)
{
	...
	GC2155MIPI_write_cmos_sensor(0xfe,0x01);
	Y_average = GC2155MIPI_read_cmos_sensor(0x14);
//dg_post = GC2155MIPI_read_cmos_sensor(0xb2);
...
#define GC2155_TEST_PATTERN_CHECKSUM 0xcaf37609 //0x5a422155
UINT32 GC2155SetTestPatternMode(kal_bool bEnable)
{
       if(bEnable){
           GC2155MIPI_write_cmos_sensor(0xfe, 0x00);
           GC2155MIPI_write_cmos_sensor(0xb6, 0x00); //aec
           GC2155MIPI_write_cmos_sensor(0x03, 0x04);
           GC2155MIPI_write_cmos_sensor(0x04, 0xf8);
           ...
           GC2155MIPI_write_cmos_sensor(0xfe, 0x00);
           GC2155MIPI_write_cmos_sensor(0x40, 0x00); //blk
           GC2155MIPI_write_cmos_sensor(0x5e, 0x00); //offset ratio
           GC2155MIPI_write_cmos_sensor(0x5f, 0x00);
           GC2155MIPI_write_cmos_sensor(0x60, 0x00);
           GC2155MIPI_write_cmos_sensor(0x61, 0x00);
           GC2155MIPI_write_cmos_sensor(0x62, 0x00);
           ...
           GC2155MIPI_write_cmos_sensor(0x64, 0x00);
           GC2155MIPI_write_cmos_sensor(0x65, 0x00);
           GC2155MIPI_write_cmos_sensor(0x66, 0x00); //dark current ratio
           GC2155MIPI_write_cmos_sensor(0x67, 0x00);
           GC2155MIPI_write_cmos_sensor(0x68, 0x00);
           GC2155MIPI_write_cmos_sensor(0x69, 0x00);

           GC2155MIPI_write_cmos_sensor(0xfe, 0x02);
           GC2155MIPI_write_cmos_sensor(0x3c, 0x00); //asde_autogray
           GC2155MIPI_write_cmos_sensor(0x4b, 0x00); //asde_y_offset
           GC2155MIPI_write_cmos_sensor(0x49, 0x00); //asde_dark_offset
           GC2155MIPI_write_cmos_sensor(0xdd, 0x00); //edge_sa

           GC2155MIPI_write_cmos_sensor(0xfe, 0x00);
           GC2155MIPI_write_cmos_sensor(0x8c, 0x04); //input_test_image
       }else{
           GC2155MIPI_write_cmos_sensor(0x8c, 0x00); //input_test_image
       }
    return ERROR_NONE;
}
