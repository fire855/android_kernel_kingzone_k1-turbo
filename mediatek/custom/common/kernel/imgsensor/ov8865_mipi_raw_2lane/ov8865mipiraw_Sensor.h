...
typedef struct
{
	...
	#define OV8865_VIDEO_PCLK 				(OV8865_PREVIEW_PCLK)
	#define OV8865_CAPTURE_PCLK 			(74400000)
	...
	#define OV8865_IMAGE_SENSOR_VIDEO_WIDTH 				(OV8865_IMAGE_SENSOR_PV_WIDTH)
	#define OV8865_IMAGE_SENSOR_VIDEO_HEIGHT				(OV8865_IMAGE_SENSOR_PV_HEIGHT)
	...
	#define OV8865_VIDEO_PERIOD_PIXEL_NUMS				OV8865_PV_PERIOD_PIXEL_NUMS
	#define OV8865_VIDEO_PERIOD_LINE_NUMS				OV8865_PV_PERIOD_LINE_NUMS
