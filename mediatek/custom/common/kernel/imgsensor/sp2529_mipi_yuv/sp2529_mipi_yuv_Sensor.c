...
SP2529MIPI_write_cmos_sensor(0x25 , 0x8f);
SP2529MIPI_write_cmos_sensor(0x21 , 0x10);
SP2529MIPI_write_cmos_sensor(0x28 , 0x0b);
SP2529MIPI_write_cmos_sensor(0x1d , 0x01);
SP2529MIPI_write_cmos_sensor(0x7a , 0x41);
...
SP2529MIPI_write_cmos_sensor(0x04 , 0xc0);  //rpc_max_indr   
SP2529MIPI_write_cmos_sensor(0x05 , 0x26);  //rpc_min_indr   
...
SP2529MIPI_write_cmos_sensor(0xeb , 0x78);   //target_indr	
...
SP2529MIPI_write_cmos_sensor(0x26 , 0x60);  //lsc_gain_thr                      
SP2529MIPI_write_cmos_sensor(0x27 , 0x14);  //lsc_exp_thrl                      
SP2529MIPI_write_cmos_sensor(0x28 , 0x05);  //lsc_exp_thrh                      
SP2529MIPI_write_cmos_sensor(0x29 , 0x00);  //lsc_dec_fac     进dummy态退shading 功能有问题，需关掉                  
SP2529MIPI_write_cmos_sensor(0x2a , 0x01);  //lsc_rpc_en lens 衰减自适应        
//LSC for CHT813                                            
SP2529MIPI_write_cmos_sensor(0xfd , 0x01);                                     
SP2529MIPI_write_cmos_sensor(0xa1 , 0x1D);  //lsc_rsx_l                                       
SP2529MIPI_write_cmos_sensor(0xa2 , 0x20);  //lsc_rsx_r                         
SP2529MIPI_write_cmos_sensor(0xa3 , 0x20);  //lsc_rsy_u                         
SP2529MIPI_write_cmos_sensor(0xa4 , 0x1D);  //lsc_rsy_d                         
SP2529MIPI_write_cmos_sensor(0xa5 , 0x1D);  //lsc_gxy_l                         
SP2529MIPI_write_cmos_sensor(0xa6 , 0x1D);  //lsc_gxy_r                         
SP2529MIPI_write_cmos_sensor(0xa7 , 0x22);  //lsc_gxy_l                         
SP2529MIPI_write_cmos_sensor(0xa8 , 0x1b);  //lsc_gxy_r                         
SP2529MIPI_write_cmos_sensor(0xa9 , 0x1c);  //lsc_bsx_l                         
SP2529MIPI_write_cmos_sensor(0xaa , 0x1e);  //lsc_bsx_r                         
SP2529MIPI_write_cmos_sensor(0xab , 0x1e);  //lsc_bsy_u                         
SP2529MIPI_write_cmos_sensor(0xac , 0x1c);  //lsc_bsy_d                         
SP2529MIPI_write_cmos_sensor(0xad , 0x0a);  //lsc_rxy_lu                        
SP2529MIPI_write_cmos_sensor(0xae , 0x09);  //lsc_rxy_ru                        
SP2529MIPI_write_cmos_sensor(0xaf , 0x05);  //lsc_rxy_ld                        
SP2529MIPI_write_cmos_sensor(0xb0 , 0x05);  //lsc_rxy_rd                        
SP2529MIPI_write_cmos_sensor(0xb1 , 0x0A);  //lsc_gsx_lu                        
...
SP2529MIPI_write_cmos_sensor(0xb5 , 0x0A);  //lsc_bxy_lu                        
SP2529MIPI_write_cmos_sensor(0xb6 , 0x0a);  //lsc_bxy_ru                        
SP2529MIPI_write_cmos_sensor(0xb7 , 0x04);  //lsc_bxy_ld                        
SP2529MIPI_write_cmos_sensor(0xb8 , 0x07);  //lsc_bxy_rd                         
//awb                                
SP2529MIPI_write_cmos_sensor(0xfd , 0x02);
SP2529MIPI_write_cmos_sensor(0x26 , 0xa0);  //Red channel gain                                 
SP2529MIPI_write_cmos_sensor(0x27 , 0x96);  //Blue channel gain                                
SP2529MIPI_write_cmos_sensor(0x28 , 0xcc);  //Y top value limit                                
SP2529MIPI_write_cmos_sensor(0x29 , 0x01);  //Y bot value limit                                
SP2529MIPI_write_cmos_sensor(0x2a , 0x00);  //rg_limit_log                                     
SP2529MIPI_write_cmos_sensor(0x2b , 0x00);  //bg_limit_log                                     
...
SP2529MIPI_write_cmos_sensor(0x1f , 0x06);  //skin detect v bot                                
 //d65 10                           
...
SP2529MIPI_write_cmos_sensor(0x65 , 0x5a);
 //f                                
...
SP2529MIPI_write_cmos_sensor(0x57 , 0x30); //raw_sharp_y_base     
SP2529MIPI_write_cmos_sensor(0x58 , 0x10); //raw_sharp_y_min      
SP2529MIPI_write_cmos_sensor(0x59 , 0xe0); //raw_sharp_y_max      
SP2529MIPI_write_cmos_sensor(0x5a , 0x00); //raw_sharp_rangek_neg 
SP2529MIPI_write_cmos_sensor(0x5b , 0x12); //raw_sharp_rangek_pos 
                                   
SP2529MIPI_write_cmos_sensor(0xcb , 0x08); //raw_sharp_range_base_outdoor	
SP2529MIPI_write_cmos_sensor(0xcc , 0x0b); //raw_sharp_range_base_nr 	
SP2529MIPI_write_cmos_sensor(0xcd , 0x10); //raw_sharp_range_base_dummy	
SP2529MIPI_write_cmos_sensor(0xce , 0x1a); //raw_sharp_range_base_low	
                                   
SP2529MIPI_write_cmos_sensor(0xfd , 0x03);
SP2529MIPI_write_cmos_sensor(0x87 , 0x04); //raw_sharp_range_ofst1	4x  
SP2529MIPI_write_cmos_sensor(0x88 , 0x08); //raw_sharp_range_ofst2	8x  
SP2529MIPI_write_cmos_sensor(0x89 , 0x10); //raw_sharp_range_ofst3	16x 
                                   
                                   
SP2529MIPI_write_cmos_sensor(0xfd , 0x02); 
SP2529MIPI_write_cmos_sensor(0xe8 , 0x58); //sharpness gain for increasing pixel’s Y, in outdoor        
SP2529MIPI_write_cmos_sensor(0xec , 0x68); //sharpness gain for decreasing pixel’s Y, in outdoor        
SP2529MIPI_write_cmos_sensor(0xe9 , 0x60); //sharpness gain for increasing pixel’s Y, in normal         
SP2529MIPI_write_cmos_sensor(0xed , 0x68); //sharpness gain for decreasing pixel’s Y, in normal         
SP2529MIPI_write_cmos_sensor(0xea , 0x58); //sharpness gain for increasing pixel’s Y,in dummy           
SP2529MIPI_write_cmos_sensor(0xee , 0x60); //sharpness gain for decreasing pixel’s Y, in dummy          
SP2529MIPI_write_cmos_sensor(0xeb , 0x48); //sharpness gain for increasing pixel’s Y,in lowlight        
SP2529MIPI_write_cmos_sensor(0xef , 0x40); //sharpness gain for decreasing pixel’s Y, in low light      
                                    
SP2529MIPI_write_cmos_sensor(0xfd , 0x02); //skin sharpen                                   
SP2529MIPI_write_cmos_sensor(0xdc , 0x04); //skin_sharp_sel肤色降锐化                       
SP2529MIPI_write_cmos_sensor(0x05 , 0x6f); //skin_num_th2排除肤色降锐化对分辨率卡引起的干扰 
                                    
//平滑自适应                        
SP2529MIPI_write_cmos_sensor(0xfd , 0x02);
SP2529MIPI_write_cmos_sensor(0xf4 , 0x30);  //raw_ymin           
SP2529MIPI_write_cmos_sensor(0xfd , 0x03);                      
SP2529MIPI_write_cmos_sensor(0x97 , 0x98);  //raw_ymax_outdoor   
SP2529MIPI_write_cmos_sensor(0x98 , 0x88);  //raw_ymax_normal    
SP2529MIPI_write_cmos_sensor(0x99 , 0x88);  //raw_ymax_dummy     
...
SP2529MIPI_write_cmos_sensor(0xfd , 0x03);
SP2529MIPI_write_cmos_sensor(0x72 , 0x18);  //raw_lsc_fac_outdoor 
SP2529MIPI_write_cmos_sensor(0x73 , 0x28);  //raw_lsc_fac_normal  
SP2529MIPI_write_cmos_sensor(0x74 , 0x28);  //raw_lsc_fac_dummy   
SP2529MIPI_write_cmos_sensor(0x75 , 0x30);  //raw_lsc_fac_low     
...
SP2529MIPI_write_cmos_sensor(0x81 , 0x02);//raw_grgb_thr_outdoor  
SP2529MIPI_write_cmos_sensor(0x82 , 0x20);
SP2529MIPI_write_cmos_sensor(0x83 , 0x20);
SP2529MIPI_write_cmos_sensor(0x84 , 0x08);
                                   
SP2529MIPI_write_cmos_sensor(0xfd , 0x03);
SP2529MIPI_write_cmos_sensor(0x7e , 0x06); //raw_noise_base_outdoor                   
SP2529MIPI_write_cmos_sensor(0x7f , 0x0d); //raw_noise_base_normal                    
SP2529MIPI_write_cmos_sensor(0x80 , 0x10); //raw_noise_base_dummy                     
SP2529MIPI_write_cmos_sensor(0x81 , 0x16); //raw_noise_base_low                       
SP2529MIPI_write_cmos_sensor(0x7c , 0xff); //raw_noise_base_dark                      
SP2529MIPI_write_cmos_sensor(0x82 , 0x54); //raw_dns_fac_outdoor,raw_dns_fac_normal} 
SP2529MIPI_write_cmos_sensor(0x83 , 0x43); //raw_dns_fac_dummy,raw_dns_fac_low}         
SP2529MIPI_write_cmos_sensor(0x84 , 0x00);  //raw_noise_ofst1 	4x                   
SP2529MIPI_write_cmos_sensor(0x85 , 0x20);  //raw_noise_ofst2	8x                   
SP2529MIPI_write_cmos_sensor(0x86 , 0x40); //raw_noise_ofst3	16x    
...
//CCM                              
SP2529MIPI_write_cmos_sensor(0xfd , 0x02); 
SP2529MIPI_write_cmos_sensor(0x15 , 0xa9); 
SP2529MIPI_write_cmos_sensor(0x16 , 0x84); 
 //!F                               
SP2529MIPI_write_cmos_sensor(0xa0 , 0x97);
SP2529MIPI_write_cmos_sensor(0xa1 , 0xea);
SP2529MIPI_write_cmos_sensor(0xa2 , 0xff);
SP2529MIPI_write_cmos_sensor(0xa3 , 0x0e);
SP2529MIPI_write_cmos_sensor(0xa4 , 0x77);
SP2529MIPI_write_cmos_sensor(0xa5 , 0xfa);
SP2529MIPI_write_cmos_sensor(0xa6 , 0x08);
SP2529MIPI_write_cmos_sensor(0xa7 , 0xcb);
SP2529MIPI_write_cmos_sensor(0xa8 , 0xad);
SP2529MIPI_write_cmos_sensor(0xa9 , 0x3c);
SP2529MIPI_write_cmos_sensor(0xaa , 0x30);
SP2529MIPI_write_cmos_sensor(0xab , 0x0c); 
   //F                              
SP2529MIPI_write_cmos_sensor(0xac , 0x7f);
SP2529MIPI_write_cmos_sensor(0xad , 0x08);
SP2529MIPI_write_cmos_sensor(0xae , 0xf8);
SP2529MIPI_write_cmos_sensor(0xaf , 0xff);
SP2529MIPI_write_cmos_sensor(0xb0 , 0x6e);
SP2529MIPI_write_cmos_sensor(0xb1 , 0x13);
SP2529MIPI_write_cmos_sensor(0xb2 , 0xd2);
SP2529MIPI_write_cmos_sensor(0xb3 , 0x6e);
SP2529MIPI_write_cmos_sensor(0xb4 , 0x40);
SP2529MIPI_write_cmos_sensor(0xb5 , 0x30);
SP2529MIPI_write_cmos_sensor(0xb6 , 0x03);
SP2529MIPI_write_cmos_sensor(0xb7 , 0x1f);
                                   
SP2529MIPI_write_cmos_sensor(0xfd , 0x01);  //auto_sat                 
SP2529MIPI_write_cmos_sensor(0xd2 , 0x2d);  //autosat_en[0]             
SP2529MIPI_write_cmos_sensor(0xd1 , 0x38);  //lum thr in green enhance 
SP2529MIPI_write_cmos_sensor(0xdd , 0x3f); 
SP2529MIPI_write_cmos_sensor(0xde , 0x37); 
...
SP2529MIPI_write_cmos_sensor(0xc6 , 0x60);
SP2529MIPI_write_cmos_sensor(0xc7 , 0x00);
SP2529MIPI_write_cmos_sensor(0xc8 , 0x00);
                                   
//sat u                            
SP2529MIPI_write_cmos_sensor(0xfd , 0x01);
SP2529MIPI_write_cmos_sensor(0xd3 , 0xa0);
SP2529MIPI_write_cmos_sensor(0xd4 , 0xa0);
SP2529MIPI_write_cmos_sensor(0xd5 , 0xa0);
SP2529MIPI_write_cmos_sensor(0xd6 , 0xa0);
//sat v                            
SP2529MIPI_write_cmos_sensor(0xd7 , 0xa0);
SP2529MIPI_write_cmos_sensor(0xd8 , 0xa0);
SP2529MIPI_write_cmos_sensor(0xd9 , 0xa0);
SP2529MIPI_write_cmos_sensor(0xda , 0xa0);
...
SP2529MIPI_write_cmos_sensor(0x7b , 0x40);
 //auto_sat                        
SP2529MIPI_write_cmos_sensor(0xfd , 0x01);
SP2529MIPI_write_cmos_sensor(0xc2 , 0xaa);  //u_v_th_outdoor白色物体表面有彩色噪声降低此值    
SP2529MIPI_write_cmos_sensor(0xc3 , 0xaa);  //u_v_th_nr                                       
SP2529MIPI_write_cmos_sensor(0xc4 , 0x66);  //u_v_th_dummy                                    
SP2529MIPI_write_cmos_sensor(0xc5 , 0x66);  //u_v_th_low          
                                    
//low_lum_offset                    
SP2529MIPI_write_cmos_sensor(0xfd , 0x01);
SP2529MIPI_write_cmos_sensor(0xcd , 0x08);
SP2529MIPI_write_cmos_sensor(0xce , 0x18);
//gw                                
SP2529MIPI_write_cmos_sensor(0xfd , 0x02);
...
SP2529MIPI_write_cmos_sensor(0x10 , 0x88); //ku_outdoor       
SP2529MIPI_write_cmos_sensor(0x11 , 0x88); //ku_nr            
SP2529MIPI_write_cmos_sensor(0x12 , 0x90); //ku_dummy         
SP2529MIPI_write_cmos_sensor(0x13 , 0x90); //ku_low           
SP2529MIPI_write_cmos_sensor(0x14 , 0x9a); //kl_outdoor       
SP2529MIPI_write_cmos_sensor(0x15 , 0x9a); //kl_nr            
SP2529MIPI_write_cmos_sensor(0x16 , 0x8b); //kl_dummy         
SP2529MIPI_write_cmos_sensor(0x17 , 0x88); //kl_low           
                                   
SP2529MIPI_write_cmos_sensor(0xfd , 0x03);
SP2529MIPI_write_cmos_sensor(0x00 , 0x80); //ctf_heq_mean	                          
SP2529MIPI_write_cmos_sensor(0x03 , 0x68); //ctf_range_thr   可以排除灰板场景的阈值   
SP2529MIPI_write_cmos_sensor(0x06 , 0xd8); //ctf_reg_max	                          
SP2529MIPI_write_cmos_sensor(0x07 , 0x28); //ctf_reg_min	                          
SP2529MIPI_write_cmos_sensor(0x0a , 0xfd); //ctf_lum_ofst                             
SP2529MIPI_write_cmos_sensor(0x01 , 0x16); //ctf_posk_fac_outdoor                     
SP2529MIPI_write_cmos_sensor(0x02 , 0x16); //ctf_posk_fac_nr                          
SP2529MIPI_write_cmos_sensor(0x04 , 0x16); //ctf_posk_fac_dummy                       
SP2529MIPI_write_cmos_sensor(0x05 , 0x16); //ctf_posk_fac_low                         
SP2529MIPI_write_cmos_sensor(0x0b , 0x40); //ctf_negk_fac_outdoor                     
SP2529MIPI_write_cmos_sensor(0x0c , 0x40); //ctf_negk_fac_nr                          
SP2529MIPI_write_cmos_sensor(0x0d , 0x40); //ctf_negk_fac_dummy                       
SP2529MIPI_write_cmos_sensor(0x0e , 0x40); //ctf_negk_fac_low                         
SP2529MIPI_write_cmos_sensor(0x08 , 0x0c); 
SP2529MIPI_write_cmos_sensor(0x09 , 0x0c); 
...
SP2529MIPI_write_cmos_sensor(0x35 , 0x41);  //YUYV                            
SP2529MIPI_write_cmos_sensor(0xfd , 0x00);        
