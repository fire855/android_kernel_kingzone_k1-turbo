...
/////////////disable blk///////////////////
  GC0329_write_cmos_sensor(0x26, 0x00);
	GC0329_write_cmos_sensor(0x2a, 0x40);
	GC0329_write_cmos_sensor(0x2b, 0x40);
	GC0329_write_cmos_sensor(0x2c, 0x40);
	GC0329_write_cmos_sensor(0x2d, 0x40);
	Sleep(200);

	////////////////////analog////////////////////
	GC0329_write_cmos_sensor(0x0a, 0x02); //row_start_low
	GC0329_write_cmos_sensor(0x0c, 0x02); //col_start_low
	if(1 == sensor_index)//if(0 == strncmp(VANZO_SUB_CAM_ROTATION, "180", 3))
	GC0329_write_cmos_sensor(0x17, 0x17);
	 else
	GC0329_write_cmos_sensor(0x17, 0x14);
//	GC0329_write_cmos_sensor(0x17, 0x16); //cisctl_mode1//[7]hsync_always ,[6] NA, [5:4] CFA sequence [3:2]NA,[1]upside_down, [0] mirror
	...
	GC0329_write_cmos_sensor(0x24, 0x17); //PAD_drv//[7:6]NA,[5:4]sync_drv [3:2]data_drv [1:0]pclk_drv
	...
	GC0329_write_cmos_sensor(0x36, 0x20);  //if write 08 turn blue
	...
	GC0329_write_cmos_sensor(0x82, 0x55); //55//DN_inc
	...
	GC0329_write_cmos_sensor(0xb5, 0x06);//02
	...
	////////////////////YCP////////////////////
	GC0329_SET_PAGE0;
	GC0329_write_cmos_sensor(0xd1, 0x2c);
	...
	GC0329_write_cmos_sensor(0x54, 0x40); //14//30//C inter
	...
	////////////////////ABS////////////////////
	GC0329_write_cmos_sensor(0x9b, 0x00); //02
...
///////////////////////////////////////////////
	...
	GC0329_write_cmos_sensor(0xfe,0x00);
	///////////////////////////////////////////////
    	GC0329GammaSelect(GC0329_RGB_Gamma_m5);//5 0:use default
...
BOOL GC0329_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			...
			GC0329_write_cmos_sensor(0xfe, 0x01);
			GC0329_write_cmos_sensor(0x13, 0x58);//50
			GC0329_write_cmos_sensor(0xfe, 0x00);
		break;
...
static void GC0329_FlashTriggerCheck(unsigned int *pFeatureReturnPara32)
{
	unsigned int shutter,shutter_limit,dg_pre,dg_post;
	GC0329_write_cmos_sensor(0xfe,0x00);
	dg_pre = GC0329_read_cmos_sensor(0x71);
	dg_post = GC0329_read_cmos_sensor(0x72);
        ...
        UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    case SENSOR_FEATURE_GET_TRIGGER_FLASHLIGHT_INFO:
         GC0329_FlashTriggerCheck(pFeatureData32);
         break;
