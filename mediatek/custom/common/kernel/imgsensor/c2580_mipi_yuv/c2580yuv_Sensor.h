...
#define C2580_FULL_PERIOD_PIXEL_NUMS  (1714)  // default pixel#(w/o dummy pixels) in UXGA mode
#define C2580_FULL_PERIOD_LINE_NUMS   (1240)  // default line#(w/o dummy lines) in UXGA mode
#define C2580_PV_PERIOD_PIXEL_NUMS    (1240)  // default pixel#(w/o dummy pixels) in SVGA mode
#define C2580_PV_PERIOD_LINE_NUMS     (1714)   // default line#(w/o dummy lines) in SVGA mode

/* SENSOR EXPOSURE LINE LIMITATION */
//#define C2580_FULL_EXPOSURE_LIMITATION    (1236)
//#define C2580_PV_EXPOSURE_LIMITATION      (671)
