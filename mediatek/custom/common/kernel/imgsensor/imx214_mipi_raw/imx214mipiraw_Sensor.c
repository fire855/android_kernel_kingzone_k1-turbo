...
void IMX214PreviewSetting(void)
{
    ...
    IMX214_write_cmos_sensor(0x0340,0x06);
    IMX214_write_cmos_sensor(0x0341,0xBC);
    ...
    IMX214_write_cmos_sensor(0x0902,0x02);
    IMX214_write_cmos_sensor(0x3000,0x35);
    ...
    IMX214_write_cmos_sensor(0x0305,0x02);
    IMX214_write_cmos_sensor(0x0306,0x00);
    IMX214_write_cmos_sensor(0x0307,0x36);
    IMX214_write_cmos_sensor(0x0309,0x0A);
    IMX214_write_cmos_sensor(0x030B,0x02);
    IMX214_write_cmos_sensor(0x0310,0x00);
     
     

    IMX214_write_cmos_sensor(0x0820,0x05);
    IMX214_write_cmos_sensor(0x0821,0x10);
    ...
    IMX214_write_cmos_sensor(0x3A05,0x01);
    ...
    IMX214_write_cmos_sensor(0x3011,0x00);
    IMX214_write_cmos_sensor(0x3013,0x01);
     
     

    //IMX214_write_cmos_sensor(0x0200x06 09);
    //IMX214_write_cmos_sensor(0x0200xB2 DC);
    IMX214_write_cmos_sensor(0x0224,0x01);
    IMX214_write_cmos_sensor(0x0225,0xF4);
     
     

    //IMX214_write_cmos_sensor(0x0200x00 00);
    //IMX214_write_cmos_sensor(0x0200x00 00);
...
void IMX214VideoSetting(void)
{
    ...
    IMX214_write_cmos_sensor(0x0306,0x00);
    IMX214_write_cmos_sensor(0x0307,0x51);
    IMX214_write_cmos_sensor(0x0309,0x0A);
    ...
    IMX214_write_cmos_sensor(0x0820,0x0A);
    IMX214_write_cmos_sensor(0x0821,0x20);
    IMX214_write_cmos_sensor(0x0822,0x00);
    IMX214_write_cmos_sensor(0x0823,0x00);
...
void IMX214CaptureSetting(void)
{
    ...
    IMX214_write_cmos_sensor(0x0341,0x7A);
    IMX214_write_cmos_sensor(0x0342,0x13);
    IMX214_write_cmos_sensor(0x0343,0x90);
    IMX214_write_cmos_sensor(0x0344,0x00);
    IMX214_write_cmos_sensor(0x0345,0x00);
    ...
    IMX214_write_cmos_sensor(0x0305,0x03);
    IMX214_write_cmos_sensor(0x0306,0x00);
    IMX214_write_cmos_sensor(0x0307,0x64);
    IMX214_write_cmos_sensor(0x0309,0x0A);
    IMX214_write_cmos_sensor(0x030B,0x01);
    IMX214_write_cmos_sensor(0x0310,0x00);
    ...
    IMX214_write_cmos_sensor(0x0820,0x0C);
    IMX214_write_cmos_sensor(0x0821,0x80);
    IMX214_write_cmos_sensor(0x0822,0x00);
    IMX214_write_cmos_sensor(0x0823,0x00);
          
          

    IMX214_write_cmos_sensor(0x3A03,0x09);
...
void IMX214SetFlipMirror(kal_int32 image_mirror)
{
	kal_uint8 itemp;

	itemp=IMX214_read_cmos_sensor(0x0101);
	itemp &= ~0x03;
    ...
    case IMAGE_NORMAL:
        IMX214_write_cmos_sensor(0x0101, itemp);
        break;
    case IMAGE_V_MIRROR:		   	
        IMX214_write_cmos_sensor(0x0101, itemp | 0x02);
        break;
    case IMAGE_H_MIRROR:		   	
        IMX214_write_cmos_sensor(0x0101, itemp | 0x01);
        break;
    case IMAGE_HV_MIRROR:		   	
        IMX214_write_cmos_sensor(0x0101, itemp | 0x03);
        break;
    }
}
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	IMX214SetFlipMirror(IMAGE_HV_MIRROR);
...
{      switch(ScenarioId)
	   {
		case MSDK_SCENARIO_ID_CAMERA_ZSD:
			...
			pSensorInfo->SensorCameraPreviewFrameRate=20;
		break;
