...
UINT32 IMX179MIPIOpen(void)
{
    ...
    do {
	   ...
	   spin_unlock(&imx179_drv_lock);
	   SENSORDB("func=%s,line=%d,imx179_id=%x",__func__,__LINE__,IMX179MIPI_sensor_id);
	...
	hwPowerOn(CAMERA_POWER_VCAM_A2, VOL_2800,"imx179mipiraw");
    return ERROR_NONE;
}
...
UINT32 IMX179MIPIGetSensorID(UINT32 *sensorID) 
{
    ...
    do {		
	   *sensorID =(kal_uint16)(((IMX179MIPI_read_cmos_sensor(0x0002)&&0x0f)<<8) | IMX179MIPI_read_cmos_sensor(0x0003)); 
	   SENSORDB("func=%s,line=%d,imx179_id=%x",__func__,__LINE__,*sensorID);
...
UINT32 IMX179MIPIClose(void)
{
    ...
    hwPowerDown(CAMERA_POWER_VCAM_A2,"imx179mipiraw");
    return ERROR_NONE;
}	/* IMX179MIPIClose() */
