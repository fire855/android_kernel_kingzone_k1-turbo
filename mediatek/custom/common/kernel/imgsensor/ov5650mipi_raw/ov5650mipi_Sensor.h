...
#define OV5650MIPI_PREVIEW_CLK                      66560000
#define OV5650MIPI_CAPTURE_CLK                      66560000
#define OV5650MIPI_VIDEO_CLK                        66560000

    /* DEFINITION USED BY CCT */
//    extern SensorInfo OV5650MIPI_g_CCT_MainSensor;
  //  extern kal_uint8 OV5650MIPI_g_CCT_FirstGrabColor;

	#define OV5650MIPI_VIDEO_NORMALMODE_FRAME_RATE		(20)
	#define OV5650MIPI_VIDEO_NIGHTMODE_FRAME_RATE		(10)
    ...
    //#define OV5650MIPI_XGA_MODE_WITHOUT_DUMMY_PIXELS   (3252)  //(OV5650MIPI_QXGA_MODE_WITHOUT_DUMMY_PIXELS / 2)    // XGA mode's pixel # in one HSYNC w/o dummy pixels
    ...
    #define OV5650MIPI_QXGA_MODE_WITHOUT_DUMMY_LINES   (2046)//(1568)  // QXGA mode's HSYNC # in one HSYNC w/o dummy lines
    #define OV5650MIPI_XGA_MODE_WITHOUT_DUMMY_LINES    (1023)  //(984)//(784)   // XGA mode's HSYNC # in one HSYNC w/o dummy lines
...
#define OV5650MIPI_FULL_PERIOD_PIXEL_NUMS          (2600) /* 15 fps */
#define OV5650MIPI_FULL_PERIOD_LINE_NUMS           (1948)

//#define OV5650MIPI_PV_PERIOD_PIXEL_NUMS            (2560) /* 30 fps */
//#define OV5650MIPI_PV_PERIOD_LINE_NUMS             (960)

#define OV5650MIPI_VIDEO_PERIOD_PIXEL_NUMS         (2560) /* 30 fps */
#define OV5650MIPI_VIDEO_PERIOD_LINE_NUMS          (960)
