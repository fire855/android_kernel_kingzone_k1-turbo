...
void GC0313MIPI_Sensor_Init(void)
{
	...
	////////////////// Analog & CISCTL //////////////////
	/////////////////////////////////////////////////////
	GC0313MIPI_write_cmos_sensor(0x17, 0x17); // 0x14
	...
	GC0313MIPI_write_cmos_sensor(0x41, 0x22);
	GC0313MIPI_write_cmos_sensor(0x42, 0xff);
	...
	GC0313MIPI_write_cmos_sensor(0xb4, 0xe0);
	...
	GC0313MIPI_write_cmos_sensor(0x82, 0x78);
	...
	GC0313MIPI_write_cmos_sensor(0x13, 0x45);
	...
	GC0313MIPI_write_cmos_sensor(0xa8, 0x00);
	GC0313MIPI_write_cmos_sensor(0xa9, 0x00);
	GC0313MIPI_write_cmos_sensor(0xaa, 0x00);
	GC0313MIPI_write_cmos_sensor(0xab, 0x00);
	GC0313MIPI_write_cmos_sensor(0xac, 0x00);
	...
	GC0313MIPI_write_cmos_sensor(0xb4, 0x21);
	GC0313MIPI_write_cmos_sensor(0xb5, 0x1e);
	GC0313MIPI_write_cmos_sensor(0xb6, 0x18);
	GC0313MIPI_write_cmos_sensor(0xba, 0x28);
	GC0313MIPI_write_cmos_sensor(0xbb, 0x24);
	GC0313MIPI_write_cmos_sensor(0xbc, 0x1c);
	GC0313MIPI_write_cmos_sensor(0xc0, 0x15);
	GC0313MIPI_write_cmos_sensor(0xc1, 0x14);
	GC0313MIPI_write_cmos_sensor(0xc2, 0x11);
	GC0313MIPI_write_cmos_sensor(0xc6, 0x12);
	GC0313MIPI_write_cmos_sensor(0xc7, 0x12);
	GC0313MIPI_write_cmos_sensor(0xc8, 0x11);
	GC0313MIPI_write_cmos_sensor(0xb7, 0x20);
...
UINT32 GC0313MIPIGetSensorID(UINT32 *sensorID)
{
    ...
    do
    {
        	...
        	for(i = 0; i < 3; i++)
		{
	            	...
	            	if (sensor_id == GC0313_MIPI_SENSOR_ID)
			{
	               	break;
	            	}
        	}
