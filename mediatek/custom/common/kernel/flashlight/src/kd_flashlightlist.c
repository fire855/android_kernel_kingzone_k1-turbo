...
#define PK_ERR(a,...)
#endif
/* Vanzo:maxiaojun on: Fri, 11 Apr 2014 15:33:13 +0800
 */
...
#ifdef BUILD_CTS
static DRIVER_ATTR(lighton,  0664, NULL,   flashlight_store_lighton);
#else
...
/* Vanzo:maxiaojun on: Fri, 11 Apr 2014 15:33:51 +0800
 */
...
{
    PK_DBG("[flashlight_probe] start\n");
/* Vanzo:maxiaojun on: Fri, 11 Apr 2014 15:34:19 +0800
 */
