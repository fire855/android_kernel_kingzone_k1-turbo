...
static int GES_INTT				= EPL_INTT_ALS_150;
static int GES_CYCLE			= 0;
static int GES_GAIN				= 1;
...
void epl8865_polling_work(struct work_struct *work)
{
    ...
    if((enable_ps && obj->hw->polling_mode_ps == 1) || (enable_als==true && enable_ges==false && enable_hs==false) ||(enable_ps && enable_als) || (enable_als==true && enable_ps==false))
    {
