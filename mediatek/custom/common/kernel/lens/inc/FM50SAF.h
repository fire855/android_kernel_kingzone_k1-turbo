...
#define FM50SAFIOC_G_MOTORINFO _IOR(FM50SAF_MAGIC,0,stFM50SAF_MotorInfo)

#define FM50SAFIOC_T_MOVETO _IOW(FM50SAF_MAGIC,1,unsigned long)

#define FM50SAFIOC_T_SETINFPOS _IOW(FM50SAF_MAGIC,2,unsigned long)

#define FM50SAFIOC_T_SETMACROPOS _IOW(FM50SAF_MAGIC,3,unsigned long)
#ifdef LensdrvCM3
#define FM50SAFIOC_G_MOTORMETAINFO _IOR(FM50SAF_MAGIC,4,stFM50SAF_MotorMETAInfo)
#endif
