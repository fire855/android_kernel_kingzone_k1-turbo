...
#define DEVICE_DRIVER_RELEASE_VERSION   ("2.0.0.0")
 ...
 * For a mutual-capacitive ic project, please define the compile option CONFIG_ENABLE_TOUCH_DRIVER_FOR_MUTUAL_IC.
 * For a self-capacitive ic project, please define the compile option CONFIG_ENABLE_TOUCH_DRIVER_FOR_SELF_IC.
 */
...
/*
 * Note.
 * The below compile option is used to enable the specific device driver code handling when touch panel support virtual key(EX. Home, Menu, Back, Search).
 ...
 * Gesture wakeup is only supported for mutual-capacitive ic, self-capacitive ic is not supported yet.   
 * By default, this compile option is disabled.
 */
...
#else
#undef  CONFIG_ENABLE_GESTURE_WAKEUP
#endif
...
#define CHIP_TYPE_MSG22XX   (0x7A) // EX. MSG2238
...
//extern unsigned short msg_coordinate_x[150];
//extern unsigned short msg_coordinate_y[150];
