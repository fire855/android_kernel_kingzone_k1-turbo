...
// TODO : Please FAE colleage to confirm with device driver engineer of customer about the value of RST and INT GPIO setting
...
// TODO : Please FAE colleage to confirm with device driver engineer of customer about the value of RST and INT GPIO setting
#define MS_TS_MSG_IC_GPIO_RST   DrvPadmuxGetGpio(IO_CHIP_INDEX_C_TP_RST) //0
#define MS_TS_MSG_IC_GPIO_INT   DrvPadmuxGetGpio(IO_CHIP_INDEX_C_TP_INT) //1
...
extern void DrvPlatformLyrTouchDeviceRegulatorPowerOn(struct regulator *pReguVdd);
