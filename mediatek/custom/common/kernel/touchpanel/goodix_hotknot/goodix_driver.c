...
#ifdef BUILD_CTS
static DEVICE_ATTR(coordinate_x, 0664, goodix_coordinate_x_show, NULL);
#else
...
#ifdef BUILD_CTS
static DEVICE_ATTR(coordinate_y, 0664, goodix_coordinate_y_show, NULL);
#else
...
static int touch_event_handler(void *unused)
{
    ...
    do
    {
        ...
        if (key_value || pre_key)
        {
            ...
            {
/* Vanzo:maxiaojun on: Fri, 13 Jun 2014 17:07:45 +0800
                input_report_key(tpd->dev, touch_key_array[i], key_value & (0x01 << i));
 */
                    if((key_value >> i & 1) == 1){
                        input_report_key_tp(tpd->dev, touch_key_array[i], 1);
                        if(touch_key_array[i] == KEY_HOMEPAGE)
                            break;
                    }else{
                        input_report_key_tp(tpd->dev, touch_key_array[i], 0);
                    }
// End of Vanzo:maxiaojun
                /*
